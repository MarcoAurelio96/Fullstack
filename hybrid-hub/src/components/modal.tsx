...
export const Modal = ({ isOpen, onClose, children }: ModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-iron-900/90 backdrop-blur-sm">
      ...
      <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto bg-iron-800 border-2 border-iron-700 rounded-3xl shadow-2xl animate-in zoom-in-95 duration-200">
